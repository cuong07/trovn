...
function useIsEverMounted() {
  var _React$useState = React.useState(isEverMounted),
...
function EmojiList() {
  ...
  var renderdCategoriesCountRef = React.useRef(0);
  return React.createElement("ul", {
...
function Preview() {
  ...
  return React.createElement(Flex, {
    className: flairup.cx(styles$e.preview, commonInteractionStyles.hiddenOnReactions)
