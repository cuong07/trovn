    ...
    return (
        <>
            <footer className="bg-slate-50 mt-10">
                <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-16">
                    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                        <div>
                            <div className="flex justify-center w-24 text-teal-600 sm:justify-start">
            ...
            {pathname.includes("/search") && (
                <div className="flex justify-between h-10 py-4  px-10 items-center text-gray-600">
