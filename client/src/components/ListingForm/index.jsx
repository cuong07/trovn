                    ...
                    <div className="bg-white p-6 rounded-xl h-fit border">
                        <div className="mb-4">
                            ...
                            <div className="text-sm text-[#717171] ">
                                Điều quan trọng là phải kiên nhẫn, được khách
                                hàng làm theo
                            </div>
                        </div>
                ...
                <div className="col-span-1 flex flex-col gap-4">
                    ...
                    <div className="bg-white p-6 rounded-xl border h-fit">
                        <div className="mb-4">
                            ...
                            <div className="text-sm text-[#717171] ">
                                Thành phố nơi có phòng của bạn (Quan trọng không
                                được để trống)
                            </div>
                        </div>
                        <div className="grid gap-4">
                            <div className="grid gap-3" ref={ref5}>
                                ...
                                <Select
                                    ...
                                    onChange={(value) =>
                                        updateListing("locationId", value)
                                    }
                ...
                <div className="col-span-2 flex flex-col gap-4  h-fit">
                    ...
                    <div className="bg-white p-6 rounded-xl border" ref={ref7}>
                        ...
                        <div className="grid gap-3">
                            ...
                            <Select
                                ...
                                onChange={(value) =>
                                    updateListing("amenityConnections", value)
                                }
                    ...
                    <div className="bg-white p-6 rounded-xl border" ref={ref8}>
                        <div className="mb-4">
                            ...
                            <div className="text-sm text-[#717171] ">
                                #Hastag có thể giúp phòng của bạn tiếp cận được
