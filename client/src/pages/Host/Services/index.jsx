    ...
    <div className="w-full h-full bg-white rounded-lg shadow-sm p-4 ">
      <div className=" my-4 text-base">
        ...
        <div className="text-center mx-40">
          ...
          <div>
            VÌ - Giờ đây sau hơn 1 năm chúng tôi mong mỏi hơn sự đồng lòng, thấu
            hiểu từ phía khách hàng thân thương. Chúng tôi luôn mong muốn đem
            lại trải nghiệm tốt hơn, hoàn hảo hơn cho quý khách hàng trong suốt
            thời gian gắn bó. Chúng tôi quyết định điều chỉnh giá, để tồn tại và
            trên cả là phục vụ hết mình vì quý khách hàng đã, đang và sẽ đồng
            hành tại website.
          </div>
        </div>
      </div>
      <div className="grid grid-cols-4 gap-4 h-full">
        {advertisingPackages.map((item, index) => (
          <div
            key={item.id}
            className="h-2/3 flex flex-col justify-between rounded-xl shadow-md border"
          >
            <div>
              <div
